...
import ec.com.redepronik.negosys.service.TraspasoService;
...
public class TraspasoBodegaBean {
	...
	@PostConstruct
	public void init() {
		listaLocalsOrigen = localService.obtenerLista("", new Object[] {},
				false, new Object[] {});
		// obtenerPorCedulaAndCargo(
		// SecurityContextHolder.getContext().getAuthentication()
		// .getName(), 3);
		listaLocalsDestino = localService.obtenerLista("", new Object[] {},
				false, new Object[] {});
		// obtener(true);
	}
	...
	public void insertarTraspaso(ActionEvent actionEvent) {
		if (localOrigen.getId() == localDestino.getId()) {
			...
			RequestContext.getCurrentInstance().addCallbackParam("cerrar",
					false);
		} else if (traspaso.getDetallesTraspasos().isEmpty()) {
			presentaMensaje(new FacesMessage(FacesMessage.SEVERITY_INFO,
			...
			if (b == 1) {
				traspaso.setLocalOrigen(localService.obtenerObjeto("",
						new Object[] {}, false, new Object[] {}));
				// obtenerPorLocalId(localOrigen
				// .getId()));
				traspaso.setLocalDestino(localService.obtenerObjeto("",
						new Object[] {}, false, new Object[] {}));
				// obtenerPorLocalId(localDestino
				// .getId()));
	...
	public void limpiarObjetos() {
		traspaso = new Traspaso();
		traspaso.setDetallesTraspasos(new ArrayList<DetalleTraspaso>());
		localOrigen = new Local();
		localDestino = new Local();
		detalleTraspaso = new DetalleTraspaso();
	}
