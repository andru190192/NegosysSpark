...
import ec.com.redepronik.negosys.dao.CotizacionDao;
...
@Service
public class CotizacionServiceImpl extends
		GenericServiceImpl<Cotizacion, Integer> implements CotizacionService {
...
//					p.getPrecios(), k, localId, fr.getPrecioId()));
//
//			list.set(fila, fr);
//			return true;
//		}
...
//						.getProducto().getProductosTarifas()));
	...
	public boolean convertirListaFacturaReporteListaCotizacionDetalle(
		...
		boolean bn = true;
		cotizacion.setDetallesCotizaciones(new ArrayList<DetalleCotizacion>());
...
//			detalleCotizacion.setProducto(producto);
	...
	public boolean imprimirCotizacion(int cotizacionId,
		...
		if (cotizacionId == 0)
			...
			if (cotizacion == null) {
				...
				// Persona cliente =
				// clienteService.obtenerPorClienteId(cotizacion
				// .getCliente().getId());
				...
				for (DetalleCotizacion dc : cotizacion
						.getDetallesCotizaciones()) {
				...
				//
				// list.add(new CotizacionImprimir(cotizacion, cliente,
				// telefono,
	...
	public Cotizacion insertar(Cotizacion cotizacion) {
		cotizacion.setCajero(personaService.obtenerObjeto("", new Object[] {},
				false, new Object[] {}));
		// obtenerPorDocumentoYRol(
		// SecurityContextHolder.getContext().getAuthentication()
		// .getName(), Rol.BODE));
		cotizacion.setFechaEmision(timestamp());
		cotizacion.setPuntoEmision("0");
		cotizacion.setSecuencia("0");

		int c = 1;
		for (DetalleCotizacion de : cotizacion.getDetallesCotizaciones())
			de.setOrden(c++);
	...
	public List<Cotizacion> obtener(String criterioBusquedaCliente,
		...
		if (criterioBusquedaCliente.compareToIgnoreCase("") == 0
			...
			if (criterioBusquedaCliente.compareTo("") != 0) {
				list = cotizacionDao.obtenerLista("", new Object[] {}, true, new Object[] {});
				// .obtenerPorHql(
				...
				List<Cotizacion> list1 = cotizacionDao.obtenerLista("",
	...
	public Cotizacion obtenerPorCotizacionId(Integer cotizacionId) {
		Cotizacion cotizacion = (Cotizacion) cotizacionDao.obtenerLista("",
				new Object[] {}, true, new Object[] {});
		// obtenerPorHql(
		// "select distinct c from Cotizacion c "
