...
import ec.com.redepronik.negosys.daoAux.VolumenVentaFacturaDao;
	...
	public List<VolumenVentaFactura> obtenerPorFechasAndVendedorAndEstadoDocumento(
		...
		if (fechaInicio != null && fechaFin != null) {
			if (vendedorId == 0 && estadoDocumento == 0)
				list = volumenVentaFacturaDao.obtenerLista("", new Object[] {}, false, new Object[] {});
//						.obtenerPorHql(
...
//										dateCompleto(fechaFin) }, true);
	...
	public List<VolumenVentaFactura> obtenerVolumenventaFacturaPorConsumidorFinal(
		...
		return volumenVentaFacturaDao.obtenerLista("", new Object[] {}, false, new Object[] {});
		// .obtenerPorHql(
		// "select new VolumenVentaFactura("
		// + "f.id, "
		// + "f.fechaInicio, "
