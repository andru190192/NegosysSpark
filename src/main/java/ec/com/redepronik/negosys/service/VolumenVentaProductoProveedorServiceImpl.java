...
import ec.com.redepronik.negosys.daoAux.VolumenVentaProductoProveedorDao;
...
public class VolumenVentaProductoProveedorServiceImpl implements
	...
	public List<VolumenVentaProductoProveedor> obtenerPorFechasPorProveedor(
		...
		return volumenVentaProductoProveedorDao.obtenerLista("", new Object[] {}, false, new Object[] {});
		// .obtenerPorHql(
		// "select distinct "
