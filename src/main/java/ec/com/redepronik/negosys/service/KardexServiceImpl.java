...
import ec.com.redepronik.negosys.dao.KardexDao;
...
@Service
public class KardexServiceImpl extends GenericServiceImpl<Kardex, Long>
	...
	public Boolean comprobarKardexInicial(Kardex kardex) {
		List<Kardex> k = kardexDao.obtenerLista("", new Object[] {}, false,
				new Object[] {});
		// .obtenerPorHql(
	...
	public List<KardexReporte> generarkardex(Producto producto,
		...
		if (producto.getId() == null || producto.getId() == 0)
			...
			if (fechaInicio == null && fechaFinal == null) {
				...
				// local.getId() }))
				// .intValue();
				list = cargarKardex(kardexDao.obtenerLista("", new Object[] {},
						false, new Object[] {}));
				// .obtenerPorHql(
	...
	public Kardex obtenerSaldoActual(String ean) {
		List<Kardex> lk = kardexDao.obtenerLista("", new Object[] {}, false,
				new Object[] {});
		// .obtenerPorHql(
	...
	public Map<String, Object> ponderarPrecio(Producto producto, int localId,
		...
		Kardex k = obtenerSaldoActual(producto.getCodigo(), localId);
		if (k != null) {
			can = k.getCantidad();
			pre = k.getPrecio();
			k.setActivo(false);
		...
		producto.setPrecioNeto(valorNuevoPrecio);
