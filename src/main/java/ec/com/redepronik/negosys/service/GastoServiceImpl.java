...
import ec.com.redepronik.negosys.dao.GastoDao;
...
@Service
public class GastoServiceImpl extends GenericServiceImpl<Gastos, Integer>
		implements GastoService {
	...
	public void insertar(Gastos gasto) {
		String cedula = SecurityContextHolder.getContext().getAuthentication()
				.getName();
		gasto.setCajero(personaService.obtenerObjeto("", new Object[] {},
				false, new Object[] {}));

		// .obtenerPorDocumentoYRol(cedula, Rol.CAJA));
	...
	public List<Gastos> obtener(Date fechaInicio, Date fechaFin) {
		...
		if (fechaInicio == null && fechaFin == null)
			...
			list = gastoDao.obtenerLista("", new Object[] {}, false,
					new Object[] {});
			// .obtenerPorHql(
	...
	public List<Gastos> obtener(Date criterioBusquedaFecha,
		...
		if (criterioBusquedaFecha == null
			...
			// + criterioBusquedaDescripcion + "%" });
				...
				list = gastoDao.obtenerLista("", new Object[] {}, false,
						new Object[] {});
			// obtenerPorHql("Select g from Gastos g "
