...
import ec.com.redepronik.negosys.daoAux.RetencionesDao;
import ec.com.redepronik.negosys.entityAux.Retenciones;

@Service
public class RetencionesServiceImpl extends
		GenericServiceImpl<Retenciones, Integer> implements RetencionesService {
	...
	public List<Retenciones> obtener(Integer proveedorId, Date fechaInicio,
		...
		if (proveedorId == 0)
			lista = retencionesDao.obtenerLista("", new Object[] {}, false, new Object[] {});
//					.obtenerPorHql(
