...
public class UtilsMath {
	...
	public static final int tipoRedondeo = 6;
	...
	public static BigDecimal divide(BigDecimal divisor, BigDecimal dividendo) {
		try {
			return divisor.divide(dividendo, precisionDecimal, tipoRedondeo);
	...
	public static BigDecimal redondear(BigDecimal numero) {
		return numero.setScale(precisionDecimal, tipoRedondeo);
	}
	...
	public static BigDecimal redondearEscala(BigDecimal numero, int escala) {
		return numero.setScale(escala, tipoRedondeo);
	}
