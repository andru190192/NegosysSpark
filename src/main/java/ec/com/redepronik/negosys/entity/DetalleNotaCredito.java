...
public class DetalleNotaCredito implements Serializable {
	...
	@Id
	@SequenceGenerator(allocationSize = 1, name = "DETALLESNOTASCREDITOS_ID_GENERATOR", sequenceName = "DETALLESNOTASCREDITOS_ID_SEQ")
	// @GeneratedValue(strategy = GenerationType.IDENTITY)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "DETALLESNOTASCREDITOS_ID_GENERATOR")
	...
	@ManyToOne
	@JoinColumn(name = "`notaCredito`", nullable = false)
