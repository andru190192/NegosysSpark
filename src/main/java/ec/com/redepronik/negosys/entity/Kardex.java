...
public class Kardex implements Serializable {
	...
	@Column(name = "`estadoKardex`", nullable = false)
	...
	@Id
	@SequenceGenerator(allocationSize = 1, name = "KARDEXS_ID_GENERATOR", sequenceName = "KARDEXS_ID_SEQ")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "KARDEXS_ID_GENERATOR")
