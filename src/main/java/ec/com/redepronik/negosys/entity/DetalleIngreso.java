...
public class DetalleIngreso implements Serializable {
	...
	@Id
	@SequenceGenerator(allocationSize = 1, name = "DETALLESINGRESOS_ID_GENERATOR", sequenceName = "DETALLESINGRESOS_ID_SEQ")
	// @GeneratedValue(strategy = GenerationType.IDENTITY)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "DETALLESINGRESOS_ID_GENERATOR")
